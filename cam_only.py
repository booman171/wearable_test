...
while(True):
    if main == True:
        ...
        clock = bigFont.render(now.strftime("%H:%M:%S"), True, (0, 0, 0), (255, 255, 255))
        exit_button = medFont.render("Exit", True, (0, 255, 0), (255, 255, 255))
        cam_button = medFont.render("Cam", True, (0, 255, 0), (255, 255, 255))
        temp = medFont.render(temperature + " C", True, (255, 0, 0), (255, 255, 255))
        ecg = medFont.render("ECG: " + heart, True, (255, 0, 0), (255, 255, 255))
        p = medFont.render("Pitch: " + pitch, True, (0, 0, 255), (255, 255, 255))
        r = medFont.render("Roll: " + roll, True, (0, 0, 255), (255, 255, 255))
        y = medFont.render("Yaw: " + yaw, True, (0, 0, 255), (255, 255, 255))
